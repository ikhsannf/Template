...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-slate-800 flex items-center justify-center px-6 pt-20 overflow-hidden">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2 text-left">
            ...
            >
              <h2 className="text-2xl md:text-3xl text-gray-600 dark:text-gray-300 mb-8 font-light h-12">
            ...
            >
              <div className="flex items-center space-x-2 bg-white dark:bg-gray-800 px-4 py-2 rounded-full shadow-md">
                ...
                <span className="text-gray-700 dark:text-gray-300 font-medium">Bandung, Indonesia</span>
              </div>
            ...
            <motion.div
              ...
              className="pt-8"
            >
              <p className="text-gray-500 dark:text-gray-400 mb-4 text-sm uppercase tracking-wider">
                Follow me:
              </p>
          ...
          <div className="lg:w-1/2 flex justify-center lg:justify-end">
            ...
            >
              {/* Main Photo Card */}
              <motion.div
                className="w-80 h-96 bg-gradient-to-br from-blue-400 to-purple-600 rounded-2xl shadow-2xl overflow-hidden relative"
              ...
              >
                ...
                ></motion.div>
                <motion.div
                  className="absolute top-1/2 -right-8 w-16 h-16 bg-green-400 rounded-lg opacity-60 transform -translate-y-1/2"
                  animate={{
                    y: [-20, 20, -20],
                    rotate: [0, 180, 360]
                  }}
              ...
              {/* Decorative elements */}
              <div className="absolute -z-10 top-6 left-6 w-80 h-96 bg-gradient-to-br from-blue-200 to-purple-300 rounded-2xl opacity-30 group-hover:opacity-50 transition-all duration-500"></div>

              {/* Status Indicator */}
              <motion.div
                className="absolute top-6 right-6 bg-green-500 text-white px-3 py-1 rounded-full text-sm font-medium flex items-center space-x-2 shadow-lg"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
